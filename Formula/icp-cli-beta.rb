class IcpCliBeta < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "3cd30291154aa8c77f13ed612179facfe5d088a40641956e913085512ae6c42c"
    end
    on_intel do
      url "https://github.com/dfinity/icp-cli/releases/download/v#{ver}/icp-cli-x86_64-apple-darwin.tar.xz"
      sha256 "79bb6d78be2d0706143d36f0eceab7faf67add7c3330671d687c1b2953c14117"
    end
  end
  ...
  on_linux do
    ...
    on_arm do
      ...
      sha256 "4327de109009539e8d18083db53012de041aff2c3792bd25a913f65c28c0df15"
    end
    on_intel do
      url "https://github.com/dfinity/icp-cli/releases/download/v#{ver}/icp-cli-x86_64-unknown-linux-gnu.tar.xz"
      sha256 "56eea79f21f80194c6d7361c3d2eacae9279ce3318706ee62b01df599a03a12d"
    end
  end
